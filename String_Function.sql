/*SELECT empName ,ASCII(empName)  FROM dbo.staff; --ASCII of first char nameSELECT CONCAT('W3Schools', '.com');
...
SELECT NCHAR(45) AS NumberCodeToUnicode; -- ascii num convert char
